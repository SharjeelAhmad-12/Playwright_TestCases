...
export class HomePage {
  ...
  async navigateToTshirtsSection() {
    ...
    const tshirtsLink = this.page.locator('xpath=/html/body/div/div[1]/div[1]/section/nav/ul/li[2]/div/ul[1]/li[2]');
    
    await expect(tshirtsLink).toBeVisible({ timeout: 15000 });
    await tshirtsLink.waitFor({ state: 'visible', timeout: 10000 });
    ...
    if (await tshirtsLink.isVisible()) {
      ...
      throw new Error('T-shirts section not found at /html/body/div/div[1]/div[1]/section/nav/ul/li[2]/div/ul[1]/li[2]');
    }
